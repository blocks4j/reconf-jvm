...
public class PropertiesConfigurationValidator {
    ...
    private static void checkLocalCacheSettings(PropertiesConfiguration arg, Collection<String> errors) {
        errors.addAll(LocalCacheSettingsValidator.validate(arg.getLocalCacheSettings()));
    }

    private static void checkConnectionSettings(PropertiesConfiguration arg, Collection<String> errors) {
