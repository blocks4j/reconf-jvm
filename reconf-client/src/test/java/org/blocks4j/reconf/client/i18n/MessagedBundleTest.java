 ...
 */
package org.blocks4j.reconf.client.i18n;
...
public class MessagedBundleTest {
    ...
    Map<String, List<String>> basePackageBundles = new LinkedHashMap<String, List<String>>() {
        {
            put("org.blocks4j.reconf.client.", Arrays.asList("/messages_client_pt_BR.properties", "/messages_client.properties"));
            put("org.blocks4j.reconf.infra.", Arrays.asList("/messages_infra_pt_BR.properties", "/messages_infra.properties"));
        }
